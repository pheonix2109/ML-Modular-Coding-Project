...
from src.config.configuration import PREPROCESSING_OBJ_FILE_PATH,TRANSFORM_TRAIN_FILE_PATH,TRANSFORM_TEST_FILE_PATH,FEATURE_ENGINEERING_OBJ_FILE_PATH
...
class DataTransformationConfig():
    proccessed_obj_file_path = PREPROCESSING_OBJ_FILE_PATH
    transform_train_path = TRANSFORM_TEST_FILE_PATH
